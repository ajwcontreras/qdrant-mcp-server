/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f3d3d630d33c3bed35eaa799aea56b5)
// Runtime types generated with workerd@1.20260421.1 2026-04-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HyDEJobCoordinator";
	}
	interface Env {
		OPENAI_STATE: KVNamespace;
		JOBS_BUCKET: R2Bucket;
		OPENAI_BASE_URL: "https://gateway.ai.cloudflare.com/v1/6bce4120096fa9f12ecda6efff1862d0/everylo/openai";
		HYDE_MODEL: "gpt-5.4-nano";
		HYDE_QUESTION_COUNT: "12";
		MAX_BATCH_SIZE: "25";
		OPENAI_CONCURRENCY: "6";
		JOB_COORDINATOR: DurableObjectNamespace<import("./src/index").HyDEJobCoordinator>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_BASE_URL" | "HYDE_MODEL" | "HYDE_QUESTION_COUNT" | "MAX_BATCH_SIZE" | "OPENAI_CONCURRENCY">> {}
}
